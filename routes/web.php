...
//menu
    ...
    Route::post('menu/menu_list/detail/{menu_id}/storeItem', [MenuController::class, 'storeItemtoMenu'])->name('storeItem');
    Route::post('menu/menu_list/detail/{menu_id}/updateItem', [MenuController::class, 'update'])->name('updateItemMenu');
    Route::get('menu/menu_list/detail/{menu_id}/menudtllist', [MenuController::class, 'MenuDtlList'])->name('MenuDtlList');
});
